...
export default function OrdersTable({ orders, onStatusChange }: { orders: any[], onStatusChange: (id: number, status: string) => void }) {
  return (
    <div className="bg-card border border-border p-6 rounded-lg">
      <h3 className="text-lg font-serif tracking-wide mb-6">Gestion des Commandes</h3>
